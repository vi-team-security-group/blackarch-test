...
#=============================================================================
	...
	# + ---=> [ Tested On Kali Linux and BlackArch Linux #

    # + ---=> [ contact me in mastervi@mail.bg #

# + ---=> [ Improve vi.sh command in here
...
function ngerusuhlo {
	clear
        echo -e $white"Wrong input , try again."
        pause
        clear
}
...
echo  -e $red"#|  :  | |  |       |  |  |   [_ |  _  | |   |   |"
echo  -e $red"# \   /  |  |       |  |  |     ||  |  | |   |   |"
echo  -e $red"#  \_/  |____|      |__|  |_____||__|__| |___|___|"
echo
...
case $lalinselc in
	"Add Myrepositories")
		...
		pause
		clear ;;
        "Update sources.list")fetch_keyring
                clear
		echo -e "\033[31m====== Adding new sources list and updating ======\033[m"
		rm /etc/apt/sources.list
...
echo
echo -e $white""
select lalinselc in "Update Mirorrlist" "Upgrade Black Arch" "Instalizing Black Arch" "Cleaning  Black Arch" "Installing a batch manager yaourt" "Update Black Arch" "Back to Main"; do
case $lalinselc in
	"Update Mirrorlist")
clear ;;
	...
	"Update Black Arch")
		clear
		echo -e "\033[32mUpdating and Cleaning Blackarch\033[m"
                pacman -Sy
		echo -e "\033[32mDone updating BlackArch\033[m" 
                pause
		clear ;;
	...
	"Upgrade Black Arch")
		...
		echo -e "\033[32mUpdating and Cleaning Blackarch\033[m"
		pacman -Syyu 
		echo -e "\033[32mDone updating and cleaning Blackarch\033[m" 
                
               pause
		clear ;; 

        "Installing a batch manager  yaourt")
                 clear
		echo -e "\033[32mReady for life \033[m"
                pacman -S  yaourt
		echo -e "\033[32mReady for work in  BlackArch\033[m" 
                pause
		clear ;;
          ...
          "Cleaning  BlackArch" )
                clear
		echo -e "\033[32mCleaning Blackarch\033[m"
		pacman -Scc
		echo -e "\033[32mBlackarch is Clean !\033[m" 
                
               pause
		clear ;; 


          "Instalizing Black Arch" )
                clear
		echo -e "\033[32mCleaning Blackarch\033[m"
...
echo
echo  -e $white "http://www.Blackarchlinux.org"
echo
echo  -e $yellow "Master Vi (Zhivko)  Founder on Vi Team Security Group "
echo
echo  -e $cyan "https://github.com/vi-team-security-group/blackarch-test"
echo
echo  -e $red"#|  |  ||    |    |      |  /  _] /    | |   |   |"
echo  -e $red"#|  |  | |  |     |      | /  [_ |  o  | | _   _ |"
echo  -e $red"#|  |  | |  |     |_|  |_||    _]|     | |  \_/  |"
...
echo -e $white"             ==============================================================="                
echo -e $white"             |                                           "                 
echo -e $white"             |$red Vi Team "$red"LINUX$red TOOLKIT $red v3.0 $red "        
echo -e $white"             |                                                             |
                            |$red Kali-rolling$red  $red and  "$red"BlackArch Linux$red "  
echo -e $white"             |                                                             |
                            |$red Contact me  mastervi@mail.bg $white "                 
echo -e $white"             |                                                             |
                            |$red Powered by "$red"Master Vi" $red" [Vi Team Security Group]$red"  
echo -e $white"             |                                                             |
                            | $red  	 Changelog: $red 10/03/2017   	$red"             
echo -e $white"             |                                          "                  
echo -e $white"             ==============================================================="                
echo
echo
echo -e $white""
select lalinselc in "Update Kali" "Update Black Arch" "Virtual Machine" "Browsers" "WiFu" "Exploit-db" "Sniffing&MITM" "Firefox Security Toolkit" "HackPack" "HID Attack Payload" "BACKDOOR" "Lazynmap" "Exploit Development" "Start Services" "Fixing all problem" "DECRYTPTER & ENCRYPTER" "LazyMacchanger" "Web Security" "Credits" "Exit"; do
case $lalinselc in
	"Update Kali")
		updatekali
		clear ;;
	...
	"Exit")
		zenity --info --text "Thanks for use Vi scripts Master Vi main developer of Vi Team"
		clear && exit 0 ;;
