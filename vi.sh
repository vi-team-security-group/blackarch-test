...
echo
echo -e $white""
select lalinselc in "Update Kali" "Virtual Machine" "Browsers" "WiFu" "Black Arch" "Exploit-db" "Sniffing&MITM" "Firefox Security Toolkit" "HackPack" "HID Attack Payload" "BACKDOOR" "Lazynmap" "Exploit Development" "Start Services" "Fixing all problem" "DECRYTPTER & ENCRYPTER" "LazyMacchanger" "Web Security" "Credits" "Exit"; do
case $lalinselc in
	"Update Kali")
		updatekali
		clear ;;
